...
Please refer to "Apollo4 OEM Provisioning Process and Tools" User's Guide on how to use these tools.

Note: The Apollo5 Security docs have not yet been published - Please continue to use the Apollo4 document for reference 
...
The tool is downloaded in SRAM at address 0x20030000, and the OEM encrypted assets (generated using provided tools), at the SRAM address 0x20037000.
